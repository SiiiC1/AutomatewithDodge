...
export function ToolCard({ tool }: ToolCardProps) {
  ...
  return (
    <motion.div
      className="relative glass rounded-xl p-3 flex flex-col items-center gap-1.5 cursor-default overflow-hidden"
    ...
    >
      ...
      <motion.div
        className="w-9 h-9 rounded-lg flex items-center justify-center text-xs font-bold font-heading"
